    ...
    public static void main(String[] args) {
        ...
        while (choice != 6) {
            ...
            if (choice == 1) {
                ...
                String didthis = kb.next() + kb.nextLine();
                nice.get(kids.get(bush)).add(didthis);
                ...
                String didthis = kb.next() + kb.nextLine();
                naughty.get(kids.get(bush)).add(didthis);
                kids.get(bush).setNiceornaughty(nice.get(kids.get(bush)).size() - naughty.get(kids.get(bush)).size());
                printNaughtyorNice(kids, nice, naughty);
                System.out.println();
                ...
                while(!santaRoute.isEmpty()){
                    Kids locations = santaRoute.remove();
                    System.out.print(locations.getName() + "  " + locations.getAddress() + " " + stocking.get(locations).size());
                    if(stocking.get(locations).isEmpty() || stocking.get(locations).peek().contains("coal")){
